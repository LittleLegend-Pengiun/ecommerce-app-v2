...
const footerColumns: FooterColumn[] = [
  {
    ...
    children: (
      <>
        <StyledTitle level={5}>Subscribe</StyledTitle>
  ...
  return (
    <StyledFooter>
      <Row gutter={[32, 32]}>
        {footerColumns.map((footerColumn) => (
          <Col key={footerColumn.title} xs={24} sm={12} md={6}>
            <StyledTitle level={footerColumn.titleLevel}>
              {footerColumn.title}
            </StyledTitle>
            <br></br>
      ...
      <StyledCopyrightRow>
        <Col span={24}>
          <StyledCopyrightedText>
            © Copyright Ecommerce-v2 2024. All rights reserved
          </StyledCopyrightedText>
        </Col>
      </StyledCopyrightRow>
    </StyledFooter>
