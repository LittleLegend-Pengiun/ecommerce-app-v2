...
import { StyledCard, CoverWrapper, NewLabel, IconsWrapper, IconButton, AddToCartButton, ActionsWrapper, Price, RatingWrapper, ColorsWrapper, ColorOption } from "./ProductCart.styles";
